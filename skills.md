...
| [`clear-kpgs-zero-trust-gate`](skills/clear-kpgs-zero-trust-gate/SKILL.md) | **PORTABLE / GOVERNANCE** | Score Academy C.L.E.A.R. + delivery CLEAR, then KPGS zero-trust before admitting skills/sprints (≥80%). | `docs/audits/2026-09-13-clear-kpgs-post-sprint-abc-reevaluation.md` |
