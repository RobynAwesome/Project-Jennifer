...
| [`jennifer-kpgs-three-classroom`](skills/jennifer-kpgs-three-classroom/SKILL.md) | **PORTABLE / CODED** | Towers’ pavilion classroom in Phaser; completing stations writes a local-experiment receipt. Three.js `autoMount` HOLD. | `apps/web/src/game/scenes/KpgsThreeClassroomScene.ts` + `kpgs-three-hold.ts` |
| [`clear-kpgs-zero-trust-gate`](skills/clear-kpgs-zero-trust-gate/SKILL.md) | **PORTABLE / GOVERNANCE** | Score Academy C.L.E.A.R. + delivery CLEAR, then KPGS zero-trust before admitting skills/sprints (≥80%). | `docs/audits/2026-09-13-clear-kpgs-classroom-love-loop.md` |
| [`jennifer-city-love-loop`](skills/jennifer-city-love-loop/SKILL.md) | **PORTABLE / CODED** | Operate the Jennifer City companion-consequence love loop under CLEAR×KPGS×HOLD-When-You-Love-It discipline. | `docs/GAME_DEDICATION_CHARTER.md`, game continuity bridges, Third Signal episode |
| [`jennifer-love-loop-reliability`](skills/jennifer-love-loop-reliability/SKILL.md) | **PORTABLE / CODED** | Same-browser Reliability bowl: localStorage-first Continue, API-death honesty, session≠relationship namespace. | `resolve-continuity.ts`, `smoke:love-loop-reliability` |
| [`clear-kpgs-product-gate`](skills/clear-kpgs-product-gate/SKILL.md) | **PORTABLE / ALIAS** | Alias of `clear-kpgs-zero-trust-gate` (same law). | points to zero-trust gate |
| [`jennifer-canonical-ops-sprints`](skills/jennifer-canonical-ops-sprints/SKILL.md) | **PORTABLE / GOVERNANCE** | Sequence canonical operation sprints from on-route evaluation receipts without silent canon promotion. | `docs/playtesting/CANONICAL_OPS_SPRINT_BOARD.md`, RTC Classroom workflows |
